...
//             setReceiptUrl(orderData.receipt);
//             window.open(orderData.receipt, "_blank");
//           }
//         }
//       } catch (e) {
...
//   if (receiptUrl && products.length === 0) {
//     return (
...
//         <NavLink
//           className="text-[11px]/[20px] text-[#0156FF] font-poppins font-normal mt-[15px]"
//           to="/SuccessOrders"
//         >
//           Check my orders
//         </NavLink>
...
//                 <div
//                   key={product.id}
//                   className="flex flex-wrap border-b-[1px] border-b-[#CACDD8] mb-[17px] gap-[13px] pb-[18px] w-[100%] xl:flex-nowrap"
//                 >
//                   <div className="flex gap-[18px] items-center">
//                     <img
//                       className="w-[68px] h-[68px] xl:w-[120px] xl:h-[120px]"
//                       src={product.images[0]}
//                       alt=""
//                     />
//                     <h2 className="text-[10px]/[15px] font-poppins font-normal xl:text-[14px]/[21px]">
//                       {product.name}
//                     </h2>
//                   </div>
...
//                   <div className="flex gap-[45px] w-[100%] justify-between items-center">
//                     <div className="flex flex-col gap-[7px]">
//                       <span className="text-[11px]/[17px] font-poppins font-semibold xl:text-[14px]/[21px]">
//                         Price
//                       </span>
//                       <span className="text-[12px]/[18px] font-poppins font-semibold xl:text-[14px]/[21px]">
//                         ${unitPrice.toFixed(2)}
//                       </span>
//                     </div>
...
//                       <div className="bg-[#F5F7FF] rounded-[15px] flex w-[56px] justify-between px-[11px] py-[5px] items-center cursor-pointer xl:w-[100px]">
//                         <span className="text-[11px]/[210%] font-poppins font-semibold text-center block xl:text-[14px]">
//                           {product.quanity}
//                         </span>
...
//                           <ChevronUp
//                             onClick={() =>
//                               dispatch(changeQuantity({ id: product.id, d: 1 }))
//                             }
//                             color="#A2A6B0"
//                             size={`16px`}
//                             className="mb-[10px]"
...
//                         className="border-[2px] border-[CACDD8] rounded-[50%] cursor-pointer"
//                         color="#A1A1A1"
//                         size="16px"
//                       />
//                     </div>
...
//           <div className="bg-[#F5F7FF] p-[10px] flex flex-col gap-[25px] items-center justify-center xl:max-w-[446px] xl:w-[100%]">
//             <div className="flex flex-row gap-[7px] items-center justify-center">
//               <span className="text-[11px]/[17px] font-poppins font-semibold xl:text-[18px]/[210%]">
//                 Total Price:
//               </span>
//               <span className="text-[12px]/[18px] font-poppins font-semibold xl:text-[18px]/[210%]">
...
//               <button
//                 onClick={handleOrder}
//                 className="w-[100%] bg-[#0156FF] py-[8px] rounded-[30px] text-[13px]/[20px] font-poppins font-semibold text-white mb-[10px] cursor-pointer xl:text-[14px]/[21px] xl:py-[15px]"
//               >
//                 Proceed to Checkout
//               </button>
...
//                 className="relative w-[100%] bg-black py-[8px] rounded-[30px] text-[13px]/[20px] font-poppins font-semibold text-white mb-[10px] cursor-pointer xl:text-[14px]/[21px] xl:py-[15px]"
//               >
//                 Clear Shopping Cart
//               </button>

//               <NavLink
//                 className="text-[11px]/[20px] text-[#0156FF] font-poppins font-normal mt-[15px] text-center block"
//                 to="/SuccessOrders"
//               >
//                 Check my orders
//               </NavLink>
...
//               <img
//                 className="w-[61px] h-[21px] mr-[8px]"
